...
/** Signature experiences, as offered on highspirits.au. */
export const experiences: Experience[] = [
  {
    ...
    description:
      "An intimate 8-seat experience where our Executive Chef crafts a personalised journey through contemporary Indian cuisine, paired with rare wines from our cellar.",
    meta: ["8 seats", "10 courses", "Chef led"],
    features: ["Personalised 10-course menu", "Chef interaction", "Kitchen tour"],
  ...
  },
  {
    ...
    features: ["Multi-cuisine spread", "Unlimited servings", "Live food counters"],
  ...
  },
  {
    ...
    description:
      "Take a relaxing midday break with our thoughtfully curated lunch menu, offering fresh flavours, quick service, and a comfortable dining atmosphere.",
    meta: ["Wed – Fri", "11:30 AM – 2:30 PM"],
    features: ["Freshly prepared lunch menu", "Quick & efficient service", "Comfortable seating"],
  ...
  },
  {
    ...
    meta: ["Up to 100 guests", "Full venue buyout"],
  ...
  },
  {
    ...
    description:
      "Get your favourites delivered straight to your door — fast, easy and hassle free. No lines, no travel, just tap and enjoy.",
    meta: ["Uber Eats", "Doorstep delivery"],
    features: ["Doorstep delivery", "Real-time order tracking", "Order through Uber Eats"],
